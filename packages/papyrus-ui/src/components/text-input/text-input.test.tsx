...
describe('TextInput', () => {
  describe('Given the text-input component with default props', () => {
  ...
  describe('Given the text-input component with `disabled` set to true', () => {
    describe('When it is rendered', () => {
  ...
  describe('Given the text-input component with `readOnly` set to true', () => {
    describe('When it is rendered', () => {
  ...
  describe('Given the text-input component with `clearable` set to true', () => {
  ...
  describe('Given the text-input component with `clearable` set to true and a custom `clearLabel`', () => {
    describe('When a user inputs text into the input field', () => {
  ...
  describe('Given the text-input component with `defaultValue` and `clearable` set to true', () => {
  ...
  describe('Given the text-input component with the `value` prop and `clearable` set to true', () => {
    describe('When the input is focused', () => {
      it('Then it should render with the clear button', async () => {
        const { getByRole } = render(
          <TextInput clearable defaultValue='Bob' />,
